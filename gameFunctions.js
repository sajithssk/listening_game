...
function ageSelected(age) {
	...
	if (age == '6-9') {
		...
		document.getElementById("difficulty").innerHTML = "You have selected the difficulty: <b>Easy</b>"
		...
		document.getElementById("secondAudio").setAttribute("src","sounds/fruit.mp3");
		document.getElementById("audioContainerTwo").load();
		
		document.getElementById("thirdAudio").setAttribute("src","sounds/cycle.mp3");
		document.getElementById("audioContainerThree").load();
		
		document.getElementById("fourthAudio").setAttribute("src","sounds/hello.mp3");
		...
		document.getElementById("difficulty").innerHTML = "You have selected the difficulty: <b>Average</b>"
		
		document.getElementById("firstAudio").setAttribute("src","sounds/government.mp3");
		document.getElementById("audioContainerOne").load();
		
		document.getElementById("secondAudio").setAttribute("src","sounds/angry.mp3");
		document.getElementById("audioContainerTwo").load();
		
		document.getElementById("thirdAudio").setAttribute("src","sounds/elephant.mp3");
		document.getElementById("audioContainerThree").load();
		
		document.getElementById("fourthAudio").setAttribute("src","sounds/recycle.mp3");
		document.getElementById("audioContainerFour").load();
		
		document.getElementById("fifthAudio").setAttribute("src","sounds/question.mp3");
		document.getElementById("audioContainerFive").load();
		...
		//changes the 'select a difficulty' text to confirm the user's difficulty selection
		document.getElementById("difficulty").innerHTML = "You have selected the difficulty: <b>Hard</b>"
		...
		document.getElementById("thirdAudio").setAttribute("src","sounds/balloon.mp3");
		document.getElementById("audioContainerThree").load();
		
		document.getElementById("fourthAudio").setAttribute("src","sounds/umbrella.mp3");
		document.getElementById("audioContainerFour").load();
		
		document.getElementById("fifthAudio").setAttribute("src","sounds/destiny.mp3");
		document.getElementById("audioContainerFive").load();
